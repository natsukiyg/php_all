...
// SQL作成&実行
$sql = 'INSERT INTO auth_table (memberId, name, gender, birthday, email, password, address, facility, user_role, is_approved, whereDidYouHear, expectations, registered_at, updated_at) VALUES (NULL, :name, :gender, :birthday, :email, :password, :address, :facility, :user_role, :is_approved, :whereDidYouHear, :expectations, now(), now())';
